          ...
          <div class="container">
              <div class="row justify-content-between">
                  <div class="col-md-7 col-lg-6 col-xl-5">
                      ...
                      <form class="contact-form" id="contact_form_submit" action="/register" method="POST">
                        @csrf
                          ...
                          <div class="form-group">
                              ...
                              <input type="text" placeholder="Enter Your Phone Number" name="phone_no" id="phone_no" required>
                          </div>
                          <div class="form-group">
                              <label for="password">Password <span>*</span></label>
                              <input name="password" id="message" placeholder="Enter Your password" required>
                          </div>
                          <div class="form-group">
