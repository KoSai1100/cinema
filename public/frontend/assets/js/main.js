(function($) {
    ...
    $(document).ready(function() {
        ...
        //     if (book == 0) {
        //         $(this).attr("src", "/frontend/assets/images/movie/seat01-free.png");
        //         book = 1;
        //     } else if (book == 1) {
        //         $(this).attr("src", "/frontend/assets/images/movie/seat01-booked.png");
        //         book = 0;
        //     }
        // });

        var book = {}; // Object to store the booked status of each seat
        $(".seat-free img").on('click', function(e) {
            var seatValue = $(this).data('value'); // Get the value of the clicked seat
            if (book[seatValue]) {
                $(this).attr("src", "/frontend/assets/images/movie/seat01-booked.png");
            } else {
                $(this).attr("src", "/frontend/assets/images/movie/seat01-free.png");
            }
            book[seatValue] = !book[seatValue];
        });
        ...
        //         var $img = $(this);
        //         if (!isBooked) {
        //             $img.attr("src", "{{ asset('frontend/assets/images/movie/seat01-free.png') }}");
        //         } else {
        //             $img.attr("src", "{{ asset('frontend/assets/images/movie/seat01-booked.png') }}");
        //         }
        //         isBooked = !isBooked;
        //     });
        // });
        ...
        $(".seat-free-two img").on('click', function(e) {
            if (bookTwo == 0) {
                $(this).attr("src", "/frontend/assets/images/movie/seat02-free.png");
                bookTwo = 1;
            } else if (bookTwo == 1) {
                $(this).attr("src", "/frontend/assets/images/movie/seat02-booked.png");
                bookTwo = 0;
            }
        });
